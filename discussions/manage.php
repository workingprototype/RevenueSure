                 ...
                 <?php if ($discussions) : ?>
                  <div class="flex flex-col gap-4">
                     <?php foreach ($discussions as $discussion): ?>
                            ...
                            <a href="<?php echo BASE_URL; ?>discussions/view?id=<?php echo $discussion['id']; ?>" class="bg-white p-4 rounded-lg shadow-sm flex justify-between items-center hover:shadow-lg transition duration-300 border-l-4 border-blue-500">
                                <div class="flex-1">
                     ...
                     <div class="flex flex-col gap-4">
                        <?php foreach ($discussions as $discussion): ?>
                            <?php if (categorize_discussion($discussion, $all_participants, $unread_counts, $last_message_times, $user_id) == 'Ongoing Discussions'): ?>
                               <a href="<?php echo BASE_URL; ?>discussions/view?id=<?php echo $discussion['id']; ?>" class="bg-white p-4 rounded-lg shadow-sm flex justify-between items-center hover:shadow-lg transition duration-300 border-l-4 border-green-500">
                                    <div class="flex-1">
                                       <p class="text-lg font-semibold text-gray-900"><?php echo htmlspecialchars($discussion['title']); ?></p>
                                       <p class="text-gray-500 text-sm">
                                                Created By: <?php echo htmlspecialchars($discussion['username']); ?> ,
                    ...
                    <div class="flex flex-col gap-4">
                        <?php foreach ($discussions as $discussion): ?>
                            <?php if (categorize_discussion($discussion, $all_participants, $unread_counts, $last_message_times, $user_id) == 'Previous Discussions'): ?>
                             <a href="<?php echo BASE_URL; ?>discussions/view?id=<?php echo $discussion['id']; ?>" class="bg-white p-4 rounded-lg shadow-sm flex justify-between items-center hover:shadow-lg transition duration-300 border-l-4 border-gray-500">
                                   <div class="flex-1">
                                       <p class="text-lg font-semibold text-gray-900"><?php echo htmlspecialchars($discussion['title']); ?></p>
                                        <p class="text-gray-500 text-sm">
                                          Created By: <?php echo htmlspecialchars($discussion['username']); ?> ,
