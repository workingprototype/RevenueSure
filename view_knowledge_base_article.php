...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_rating'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>
                ...
                window.location.href='view_knowledge_base_article.php?id={$article_id}';
              </script>";
        exit();
    }
}
...
<div class="container mx-auto p-6 fade-in">
    ...
    <div class="mt-4 flex justify-center gap-2">
        ...
        <a href="request_knowledge_base_article.php" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition duration-300 inline-block">Request Article</a>
    </div>
</div>
