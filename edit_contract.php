...
$stmt = $conn->prepare("SELECT contracts.* FROM contracts WHERE id = :contract_id");
...
$error = '';
$success = '';
$show_edit_form = false; // Initially, don't show edit form
...
<div class="container mx-auto p-6 fade-in">
    ...
    <?php endif; ?>
        ...
        <?php if ($status === 'Active' || $status === 'Sent' || $status == 'Signed'): ?>
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded-lg mb-6">
            ...
            <form method="post">
             ...
             <a href="view_contract.php?id=<?php echo $contract_id; ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 ml-2">Cancel</a>
        </form>
       </div>
   <?php endif; ?>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        <form method="POST" action="">
                           ...
                           <div class="mb-4">
                            ...
                            <div class="mb-4">
                               <label for="subject" class="block text-gray-700">Subject</label>
                                 <input type="text" name="subject" id="subject" value="<?php echo htmlspecialchars($contract['subject']); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" required>
                              </div>
                                <div class="mb-4">
            ...
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Update Contract</button>
               <div class="mt-4">
                   <a href="view_contract.php?id=<?php echo $contract_id; ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Contract</a>
             </div>
        </form>
        <!-- Category Add Modal -->
