    ...
    <?php if ($tickets): ?>
        <?php foreach ($tickets as $ticket): ?>
            <div class="bg-white rounded-lg shadow-md p-4 flex flex-col justify-between fade-in">
                   <h2 class="text-xl font-semibold text-gray-800 mb-2"><a href="view_ticket.php?id=<?php echo $ticket['id']; ?>" class="text-gray-800 hover:underline"><?php echo htmlspecialchars($ticket['title']); ?></a></h2>
                <p class="text-gray-600 text-sm mb-2"><strong>Assigned To:</strong> <?php echo htmlspecialchars($ticket['assigned_username'] ? $ticket['assigned_username'] : 'Unassigned'); ?></p>
                 ...
                 <div class="flex justify-end gap-2">
                        <a href="edit_ticket.php?id=<?php echo $ticket['id']; ?>" class="text-blue-600 hover:underline"><i class="fas fa-edit"></i></a>
                         <a href="delete_ticket.php?id=<?php echo $ticket['id']; ?>" class="text-red-600 hover:underline"><i class="fas fa-trash-alt"></i></a>
                      </div>
            </div>
        <?php endforeach; ?>
        <?php else: ?>
