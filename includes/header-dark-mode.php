...
<head>
  ...
  <style>
:root {
  --primary-color: #FFFFFF; /* Material 3 Purple */
  --secondary-color: #03DAC6; /* Material 3 Cyan */
  --text-primary: #E0E0E0; /* Light Gray for text */
  --text-secondary: #B0BEC5; /* Gray for secondary text */
  --background-dark: #121212; /* Dark background */
  --background-light: #1E1E1E; /* Slightly lighter dark background */
  --accent-color: #FFAB00; /* Amber for accents */
  --error-color: #CF6679; /* Red for errors */
  --border-color: #37474F; /* Dark border color */
  --nav-item-height: 56px; /* Material design touch target */
...
.paper-doc h1 { font-size: 2.5rem; }
.paper-doc h2 { font-size: 2rem; border-bottom: 2px solid var(--border-color); padding-bottom: 0.5rem; }
.paper-doc h3 { font-size: 1.75rem; }
.paper-doc h4 { font-size: 1.5rem; }
.paper-doc h5 { font-size: 1.25rem; }
.paper-doc h6 { font-size: 1.1rem; }
...
<body>
  ...
  <div class="flex h-screen">
    ...
    <aside id="sidebar" class="w-64 p-4 hidden md:block border-r-4 border-black">
