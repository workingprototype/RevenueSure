...
<head>
  ...
  <style>
/* Typography-Driven Design UI with beautiful icon packs */

:root {
  --primary-color: #2C3E50;    /* Deep navy for headings and accents */
  --secondary-color:  #3498DB;    /* Calm blue accent */
  --text-primary: #1e293b; /* Gray-800 */
  --text-secondary: #475569; /* Gray-600 */
  --background-light: #f8fafc; /* Slate-50 */
  --background-dark: #0f172a; /* Slate-900 */
  --accent-color: #0A4C45; /* Yellow-400 */
  --error-color: #dc2626; /* Red-600 */
  --border-color: #e5e7eb; /* Gray-200 */
  --nav-item-height: 52px; /* Increased for better touch targets */
...
.menu-item a i {
  margin-right: 0.75rem; /* Increased spacing for icons */
  width: 1.25rem;
  text-align: center;
  color: var(--text-secondary);
...
.menu-item.active > a {
  color: var(--text-primary);
  background-color: rgba(37, 99, 235, 0.08); /* Indigo-50 with low opacity */
