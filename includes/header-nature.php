...
<head>
  ...
  <style>
:root {
    --primary-color: #4A7729; /* Military Green */
    --secondary-color: #BD9B60; /* Khaki */
    --text-primary: #333333; /* Dark Gray */
    --text-secondary: #777777; /* Medium Gray */
    --background-light: #F0E68C; /* Khaki variant */
    --background-dark: #556B2F; /* Dark Olive Green */
    --accent-color: #C04000; /* Maroon */
    --error-color: #A60000; /* Dark Red */
    --border-color: #D3D3D3; /* Light Gray */
    --nav-item-height: 48px; /* Slightly smaller for a compact feel */
...
body {
    ...
    line-height: 1.5;
    font-size: 1rem;
    -webkit-font-smoothing: subpixel-antialiased; /* Adds retro text rendering */
...
h6 {
    ...
    text-shadow: 1px 1px 0px rgba(0, 0, 0, 0.1); /* Light text shadow */
}
...
a:hover {
    ...
    text-decoration: underline dotted; /* Adds a retro underline */
}
...
button {
    ...
    box-shadow: 2px 2px 0px var(--secondary-color); /* Offset shadow */
}
...
textarea {
    ...
    box-shadow: inset 2px 2px 3px rgba(0, 0, 0, 0.1); /* Inset shadow */
    color: var(--text-primary);
}
...
nav.bg-black {
    ...
    color: white;
    border-bottom: 4px double var(--accent-color); /* Double border */
...
nav a.text-xl {
    font-size: 1.5rem;
    font-weight: bold;
    letter-spacing: 0.1em; /* Adds letter spacing */
}
...
aside {
    ...
    border-right: 2px dashed var(--border-color); /* Dashed border */
...
.menu-item a i {
    margin-right: 0.6rem; /* Adjusted spacing for icons */
    width: 1.1rem;
    text-align: center;
    color: var(--text-secondary);
    opacity: 0.6; /* More desaturated */
}
...
.menu-item .submenu a {
    padding: 0.6rem 2rem; /* Adjusted padding */
    font-size: 0.8rem;
...
.menu-item.active > a {
    color: var(--text-primary);
    background-color: rgba(74, 119, 41, 0.1); /* Military Green with low opacity */
...
.submenu {
    ...
    margin-top: 0.2rem;
    border-left: 2px dotted var(--border-color); /* Dotted border */
    overflow: hidden;
    max-height: 0;
}
...
.bg-white {
    ...
    transition: all 0.3s ease-in-out;
    box-shadow: 2px 2px 3px rgba(0, 0, 0, 0.08); /* Slightly stronger shadow */
    border-radius: 0;
}
...
.top-nav-dropdown {
    ...
    border: 2px solid var(--border-color);
    border-radius: 0;
    box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.15); /* Stronger shadow */
    background-color: white;
}
...
.paper-doc {
    ...
    margin: 15px auto;
    padding: 30px 45px; /* Adjusted padding */
