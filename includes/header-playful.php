...
.paper-doc blockquote {
  margin: 20px 0;
  padding: 15px 20px;
  border-left: 6px dashed var(--primary-color);
  font-style: italic;
  color: var(--text-color);
  background-color: var(--accent-color);
}
...
.bg-white.p-6.rounded-2xl.shadow-xl.overflow-hidden > table th {
  ...
  text-align: left !important;
  border-bottom: 3px dashed var(--primary-color) !important;
  font-weight: bold !important;
...
select {
  appearance: none;
  background-image: url('data:image/svg+xml;utf8,<svg fill="%23222" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>');
  background-repeat: no-repeat;
