     ...
     <div class="bg-white p-6 rounded-lg shadow-md">
      ...
      <?php echo csrfTokenInput(); ?>
           ...
           <div class="mb-4">
            ...
            <div class="mt-4">
               <a href="<?php echo BASE_URL; ?>expenses/view?id=<?php echo $expense['id']; ?>"  class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Expense</a>
           </div>
      </form>
    </div>
