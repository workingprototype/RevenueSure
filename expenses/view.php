...
<div class="container mx-auto p-6 fade-in">
    ...
    <?php endif; ?>
                     ...
                     <hr>
                       <?php if ($expense['invoice_number']): ?>
                             <div class="mb-2 text-center">
                                 <p>
                                  Associated Invoice ID : <a href="<?php echo BASE_URL; ?>invoices/view?id=<?php echo $expense['invoice_id'] ?>" class="text-blue-600 hover:underline">#<?php echo htmlspecialchars($expense['invoice_number']); ?></a>
                                  </p>
                            </div>
                         <hr>
                    <?php endif; ?>
                       ...
                       <?php if ($expense['receipt_path']) : ?>
                           <div class="flex flex-col items-center">
                              <img src="<?php echo $expense['receipt_path']; ?>" alt="Expense Receipt" class="max-w-full h-auto object-contain max-h-48 mb-4">
                                  <a href="<?php echo BASE_URL; ?><?php echo $expense['receipt_path']; ?>" download class="text-blue-600 hover:underline">
                                     Download Receipt
                                  </a>
                           </div>
                       <?php else : ?>
      ...
      <div class="mt-4 flex justify-center gap-2">
         <a href="<?php echo BASE_URL; ?>expenses/manage" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 inline-block">Back to Expenses</a>
         <a href="<?php echo BASE_URL; ?>expenses/edit?id=<?php echo $expense['id']; ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 inline-block">Edit Expense</a>
       </div>
</div>
   <!-- Success Toast -->
     <div
