    ...
    <h1 class="text-3xl font-bold text-gray-800 mb-6 uppercase tracking-wide border-b-2 border-gray-400 pb-2">Manage Expenses</h1>
         ...
         <div class="flex flex-wrap justify-between items-center mb-8">
             <div class="flex flex-wrap gap-2">
                 <?php include 'expenses/filters.php'; ?>
             </div> </br>
             <a href="<?php echo BASE_URL; ?>expenses/add" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md uppercase tracking-wide">
    ...
    <span>Applied Filters</span>
        ...
        <?php endif; ?>
           <?php
              ...
              include 'expenses/metrics.php';
         ?>
         <div class="mt-8">
           <?php include 'expenses/table.php'; ?>
        </div>
        
        <div class="mt-8">
            <?php include 'expenses/charts.php'; ?>
        </div>
