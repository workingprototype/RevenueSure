    ...
    document.addEventListener('DOMContentLoaded', function() {
       ...
       function fetchLeads(page = 1) {
           ...
           currentPage = page;
            ...
            fetch(`fetch?search=${search}&category_id=${category}&status=${status}&start_date=${startDate}&end_date=${endDate}&page=${page}&city=${city}&state=${state}&country=${country}&per_page=${perPage}`)
