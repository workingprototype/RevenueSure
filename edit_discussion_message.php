...
if ($currentTime > $timeLimit) {
     echo "<script>alert('You cannot edit this message as its older than 1 hour.'); window.location.href='view_discussion.php?id=$discussion_id';</script>";
    exit;
}
...
<div class="container mx-auto p-6 fade-in">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form method="POST" action="">
          ...
          <div class="mt-4">
               <a href="view_discussion.php?id=<?php echo $discussion_id; ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Discussion</a>
           </div>
        </form>
     </div>
</div>
