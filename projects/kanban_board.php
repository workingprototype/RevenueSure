...
<div class="container mx-auto p-6 fade-in">
  <h1 class="text-4xl font-bold text-gray-900 mb-6">Kanban Board: <?php echo htmlspecialchars($project['name']); ?></h1>
                           ...
                           <div>
                            ...
                            <div class="flex justify-end gap-2">
                                <a href="<?php echo BASE_URL; ?>tasks/edit?id=<?php echo $task['id']; ?>" class="text-blue-600 hover:underline"> <i class="fas fa-edit"></i></a>
                                    <a href="<?php echo BASE_URL; ?>tasks/view?project_id=<?php echo $project_id ?>&task_id=<?php echo $task['id'] ?>" class="text-purple-600 hover:underline"><i class="fas fa-eye"></i></a>
                                </div>
                        </li>
                    <?php  endforeach; else: ?>
    ...
    <div class="mt-4">
        <a href="<?php echo BASE_URL; ?>view_project.php?id=<?php echo $project_id; ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 inline-block">Back to Project</a>
  </div>
<script>
