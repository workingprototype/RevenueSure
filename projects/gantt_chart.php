...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    ...
    <div class="mt-4">
         <a href="<?php echo BASE_URL; ?>projects/view?id=<?php echo $project_id; ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 inline-block">Back to Project</a>
    </div>
    <script>
