    ...
    <?php endif; ?>
     ...
     <div class="bg-gray-100 border border-gray-400 p-6 rounded-lg">
            <form method="POST" action="">
                ...
                <div class="mt-4">
                     <a href="manage_roles.php" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 uppercase tracking-wide">Back To Roles</a>
                </div>
           </form>
    </div>
</div>
