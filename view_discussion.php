                                                           ...
                                                           if($_SESSION['user_id'] === $message['user_id']){
                                                                ...
                                                                $currentTime = time();
                                                                     if($currentTime <= $timeLimit){
                                                                             echo '<a href="edit_discussion_message.php?id=' . $message['id'] . '&discussion_id='.$discussion_id.'" class="text-green-600 hover:underline">Edit</a>';
                                                                    }
                                                                echo' <a href="delete_discussion_message.php?id=' . $message['id'] . '&discussion_id='.$discussion_id.'" class="text-red-600 hover:underline ml-1">Delete</a>';
                                                            }
                                                    echo ' </div>';
                                              //Fetch attachments
                                              ...
                                              echo '<ul class="mt-4  pl-8">';
                                                foreach($attachments as $attachment){
                                                       echo ' <li class="flex items-center justify-between gap-2 border rounded-lg p-2 my-2">
                                                            <a href="'. $attachment['file_path'].'" class="text-blue-700 hover:underline" download="'.htmlspecialchars($attachment['file_name']).'">'.htmlspecialchars($attachment['file_name']).'</a>
                                                        </li>
                                                     ';
                                                  }
                                                 echo '</ul>';
