...
<?php echo csrfTokenInput(); ?>
            ...
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Update Ticket</button>
               <div class="mt-4">
                 <a href="<?php echo BASE_URL; ?>support_tickets/view?id=<?php echo $ticket_id; ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 inline-block">Back to Ticket</a>
            </div>
        </form>
</div>
