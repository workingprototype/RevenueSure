...
<div class="container mx-auto p-6 fade-in">
        ...
        <div class="w-full md:w-3/4 px-4 mb-6">
            <div class="bg-white border-2 border-gray-200 p-6 rounded-lg mb-6">
                 ...
                 <?php if ($ticket['project_name']): ?>
                     <p class="mt-4 text-gray-600"><strong>Related Project:</strong> <a href="<?php echo BASE_URL; ?>projects/view?id=<?php echo htmlspecialchars($ticket['project_id']); ?>" class="text-blue-600 hover:underline"><?php echo htmlspecialchars($ticket['project_name']); ?></a></p>
                    <?php endif; ?>
           </div>
             <!-- Add Comment -->
        <!-- Add Comment -->
            ...
            <div class="bg-white border-2 border-gray-200 p-6 rounded-lg mb-6 ">
                <h2 class="text-xl font-bold text-gray-800 mb-4">Tasks</h2>
                      <div class="flex justify-end mb-2">
                         <a href="<?php echo BASE_URL; ?>support_tickets/ticket_tasks/add?ticket_id=<?php echo $ticket_id; ?>" class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-900 transition duration-300 inline-block">Add Task</a>
                       </div>
                       <?php if($tasks): ?>
                           <ul class="space-y-2">
                                   ...
                                   <li class="bg-gray-100 p-4 rounded-lg mb-2"
                                    ...
                                    ?>;">
                                        <div class="flex justify-between">
                                                <p class="font-semibold"><a href="<?php echo BASE_URL; ?>support_tickets/ticket_tasks/edit?id=<?php echo $task['id']; ?>&ticket_id=<?php echo $ticket_id; ?>" class="hover:underline"> <?php echo htmlspecialchars($task['title']); ?></a></p>
                                                <div>
                                                    <a href="<?php echo BASE_URL; ?>support_tickets/ticket_tasks/toggle_status?id=<?php echo $task['id']; ?>&status=<?php echo $task['status'] === 'To Do' ? 'In Progress' : ($task['status'] === 'In Progress' ? 'Completed' : 'To Do'); ?>" class="text-gray-600 hover:underline">
                                                      <?php
                                                    ...
                                                    <a href="<?php echo BASE_URL; ?>support_tickets/ticket_tasks/delete?id=<?php echo $task['id']; ?>&ticket_id=<?php echo $ticket_id; ?>" class="text-red-600 hover:underline ml-2"><i class="fas fa-trash-alt"></i></a>
                                                   </div>
                                          </div>
              ...
              <div class="bg-white border-2 border-gray-200 p-6 rounded-lg">
                   <h2 class="text-xl font-bold text-gray-800 mb-4">Attachments</h2>
                        <form method="POST" action="support_tickets/upload_attachment" enctype="multipart/form-data">
                        <?php echo csrfTokenInput(); ?>
                                ...
                                <ul class="list-disc ml-6">
                                    <?php foreach ($attachments as $attachment): ?>
                                        <li class="flex justify-between items-center mb-2">
                                            <a href="<?php echo BASE_URL; ?><?php echo $attachment['file_path']; ?>" class="text-blue-600 hover:underline" download><?php echo htmlspecialchars($attachment['file_name']); ?></a>
                                               <a href="<?php echo BASE_URL; ?>support_tickets/delete_attachment?id=<?php echo $attachment['id']; ?>&ticket_id=<?php echo $ticket_id; ?>" class="text-red-600 hover:underline ml-2">Delete</a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                           <?php else: ?>
    ...
    <div class="mt-6">
        <a href="<?php echo BASE_URL; ?>support_tickets/manage" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 inline-block">Back to Tickets</a>
         <a href="<?php echo BASE_URL; ?>support_tickets/edit?id=<?php echo $ticket['id']; ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 inline-block">Edit Ticket</a>
   </div>
</div>
