                    ...
                    <?php if($tasks): ?>
                         <?php foreach ($tasks as $task): ?>
                            <tr class="border-b transition hover:bg-gray-100">
                                  <td class="px-4 py-3">
                                   <a href="view_task.php?id=<?php echo $task['id']; ?>&project_id=<?php echo $project_id; ?>" class="text-gray-800 hover:underline"><?php echo htmlspecialchars($task['task_name']); ?></a>
                                 </td>
