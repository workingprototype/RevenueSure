...
<div class="container mx-auto p-6 fade-in">
  ...
  <!-- Dashboard Metrics -->
    ...
    <div class="mb-8 flex justify-between items-center">
       <a href="<?php echo BASE_URL; ?>contracts/add" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md uppercase tracking-wide"><i class="fas fa-plus-circle mr-2"></i> Add Contract</a>
      </div>
    <!-- Contracts Table -->
                  ...
                  <tr class="border-b">
                      ...
                      <td class="px-4 py-2">
                       ...
                       <td class="px-4 py-2 flex gap-2">
                         <a href="<?php echo BASE_URL; ?>contracts/view?id=<?php echo $contract['id']; ?>" class="text-purple-600 hover:underline">View</a>
                           <a href="<?php echo BASE_URL; ?>contracts/edit?id=<?php echo $contract['id']; ?>" class="text-blue-600 hover:underline">Edit</a>
