...
<div class="container mx-auto p-6 fade-in">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-8">
           ...
           <?php if($signatures): ?>
            ...
            <!-- Signature form to take the signature  -->
             <?php if ($status === 'Sent' ||  $status === 'Active') : ?>
                <div class="mt-6">
                     <a href="<?php echo BASE_URL; ?>contracts/sign?id=<?php echo $contract['id']; ?>"  class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Add Digital Signature</a>
                  </div>
           <?php endif; ?>
       </div>
         <?php if($audit_trail): ?>
        ...
        <div class="mt-4 flex justify-center">
          <a href="<?php echo BASE_URL; ?>contracts/manage" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Contracts</a>
            <a href="<?php echo BASE_URL; ?>contracts/edit?id=<?php echo $contract['id']; ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Edit Contract</a>
       </div>
 </div>
  <style>
       .contract-content * {
