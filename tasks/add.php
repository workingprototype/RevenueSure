       ...
       if($estimated_hours > 9999.99){
        ...
        if ($stmt->execute()) {
           ...
           if($lead_id){
                 ...
                 header("Location: " . BASE_URL . "tasks/viewtasks?project_id=$selected_project_id");
            } else {
...
<h1 class="text-4xl font-bold text-gray-900 mb-6">Add Task</h1>
   <?php if ($error): ?>
...
<?php echo csrfTokenInput(); ?>
  ...
  <?php endif; ?>
       <div class="mb-4">
        ...
        <input type="text" name="task_name" id="task_name" class="w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600" required>
    </div>
    <div class="mb-4">
   ...
   <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
      <div>
          ...
          <input type="datetime-local" name="due_date" id="due_date" class="w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600" required>
      </div>
      <div>
          <label for="estimated_hours" class="block text-gray-700">Estimated Hours</label>
            <input type="number" name="estimated_hours" id="estimated_hours" class="w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600" min="0"  step="0.01" max="9999.99">
      </div>
   </div>
    <div class="mb-4">
    ...
    <button type="submit" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md">Add Task</button>
</form>
 <script>
