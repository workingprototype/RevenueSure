      ...
      <?php if ($project): ?>
           <div class="mt-6">
             ...
             <?php if($project['end_date']): ?>
                 ...
                 <?php endif; ?>
              <p>
                    <a href="<?php echo BASE_URL; ?>projects/view?id=<?php echo $project['id']; ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 inline-block">View Project</a>
                </p>
           </div>
        <?php endif; ?>
         ...
         <?php endif; ?>
         <div class="mt-4">
            <a href="<?php echo BASE_URL; ?>tasks/edit?id=<?php echo $task['id']; ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Edit Task</a>
              <?php
                if($lead_id){
                    echo ' <a href="<?php echo BASE_URL; ?>tasks/viewtasks?lead_id='.$lead_id.'" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Tasks</a>';
                 }else if($project_id){
                   echo'   <a href="<?php echo BASE_URL; ?>tasks/viewtasks?project_id='.$project_id.'" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Tasks</a>';
                }else {
                      echo ' <a href="<?php echo BASE_URL; ?>tasks/viewtasks" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300">Back to Tasks</a>';
                   }
