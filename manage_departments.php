...
<div class="container mx-auto p-6 fade-in">
    ...
    <!-- Add Department Button -->
     <div class="flex justify-between items-center mb-8">
          <a href="add_department.php" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md uppercase tracking-wide">
                    ...
                    <?php foreach ($departments as $department): ?>
                        <tr class="border-b border-gray-300">
                            ...
                            <td class="px-4 py-3 flex gap-2">
                                 <a href="edit_department.php?id=<?php echo $department['id']; ?>" class="text-blue-600 hover:underline"><i class="fas fa-edit"></i> Edit</a>
                                    <a href="delete_department.php?id=<?php echo $department['id']; ?>" class="text-red-600 hover:underline ml-2"><i class="fas fa-trash-alt"></i> Delete</a>
                               </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
