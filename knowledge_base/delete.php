    ...
    <div class="container mx-auto p-6 fade-in">
        ...
        <!-- Add Category Button -->
          <div class="flex justify-between items-center mb-8">
            <a href="<?php echo BASE_URL; ?>knowledge_base/categories/add" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md uppercase tracking-wide">
