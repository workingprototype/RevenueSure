...
<div class="container mx-auto mt-10 p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form method="POST" action="">
            ...
            <button type="submit" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md uppercase tracking-wide">Create Article</button>
        </form>
        <!-- Category Add Modal -->
