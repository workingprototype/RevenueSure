   ...
   if (isset($_POST['title']) && !isset($_POST['add_category_name'])) {
        ...
        $user_id = $_SESSION['user_id'];
            ...
            if (empty($title) || empty($content) || empty($category_id) || empty($visibility)) {
              ...
              $stmt = $conn->prepare("INSERT INTO knowledge_base_articles (title, content, category_id, visibility, user_id) VALUES (:title, :content, :category_id, :visibility, :user_id)");
...
?>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
         <form method="POST" action="">
            ...
            <button type="submit" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md">Create Article</button>
        </form>
      <!-- Category Add Modal -->
