...
?>
    ...
    <div class="container mx-auto mt-10 px-4 fade-in">
        <div class="bg-white p-8 rounded-2xl shadow-xl text-center border-l-4 border-blue-500 transition hover:shadow-2xl">
            <h1 class="text-5xl font-bold text-gray-900 mb-4">Welcome to RevenueSure</h1>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="search_leads.php" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md">Search Leads</a>
            <?php else: ?>
                <a href="register.php" class="bg-blue-700 text-white px-6 py-3 rounded-xl hover:bg-blue-900 transition duration-300 shadow-md">Get Started</a>
            <?php endif; ?>
        </div>
    </div>
